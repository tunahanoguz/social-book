...
{
    public class DeleteAuthorReviewDislikeCommandRequestValidator : AbstractValidator<DeleteAuthorReviewDislikeCommandRequest>
    {
        public DeleteAuthorReviewDislikeCommandRequestValidator()
        {
            RuleFor(x => x.Id)
                .NotNull()
                .NotEmpty()
