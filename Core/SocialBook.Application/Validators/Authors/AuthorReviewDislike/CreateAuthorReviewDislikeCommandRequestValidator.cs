...
{
    public class CreateAuthorReviewDislikeCommandRequestValidator : AbstractValidator<CreateAuthorReviewDislikeCommandRequest>
    {
        public CreateAuthorReviewDislikeCommandRequestValidator()
        {
