...
{
    public class DeleteAuthorReviewCommandRequestValidator : AbstractValidator<DeleteAuthorReviewCommandRequest>
    {
        public DeleteAuthorReviewCommandRequestValidator()
        {
            RuleFor(x => x.Id)
                .NotNull()
                .NotEmpty()
