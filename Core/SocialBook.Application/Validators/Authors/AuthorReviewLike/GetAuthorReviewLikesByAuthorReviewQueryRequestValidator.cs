...
{
    public class GetAuthorReviewLikesByAuthorReviewQueryRequestValidator : AbstractValidator<GetAuthorReviewLikesByAuthorReviewQueryRequest>
    {
        public GetAuthorReviewLikesByAuthorReviewQueryRequestValidator()
        {
