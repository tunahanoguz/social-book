...
{
    public class GetAuthorRecommendationsByAuthorQueryRequestValidator : AbstractValidator<GetAuthorRecommendationsByAuthorQueryRequest>
    {
        public GetAuthorRecommendationsByAuthorQueryRequestValidator()
        {
