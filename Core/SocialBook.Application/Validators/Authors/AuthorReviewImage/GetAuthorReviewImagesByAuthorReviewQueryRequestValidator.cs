...
{
    public class GetAuthorReviewImagesByAuthorReviewQueryRequestValidator : AbstractValidator<GetAuthorReviewImagesByAuthorReviewQueryRequest>
    {
        public GetAuthorReviewImagesByAuthorReviewQueryRequestValidator()
        {
