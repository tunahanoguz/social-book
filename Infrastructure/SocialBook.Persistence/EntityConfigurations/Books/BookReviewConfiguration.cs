    ...
    public class BookReviewConfiguration : IEntityTypeConfiguration<BookReview>
    {
        public void Configure(EntityTypeBuilder<BookReview> builder)
        {
            builder.HasData(
                ...
                new BookReview { Id = new Guid("d307dc6b-2b0a-4416-8b87-8fd009829f78"), Rating = 10, Comment = "A great book.", BookId = new Guid("3729783e-35d2-4860-9f4c-94220e96b158"), UserId = "5088a487-2384-4eb6-ac10-eac5d24ee1d1" },
                new BookReview { Id = new Guid("40118223-c0b0-48c5-8de6-ef4a24b94951"), Rating = 10, Comment = "A great book.", BookId = new Guid("5315b270-7da8-4e78-b3f6-ce402dbe7ac2"), UserId = "5088a487-2384-4eb6-ac10-eac5d24ee1d1" },
                new BookReview { Id = new Guid("61bb2e93-2110-4150-a93f-32603dd7f795"), Rating = 10, Comment = "A great book.", BookId = new Guid("79adb4fd-b77d-4595-9227-48b9e48e7465"), UserId = "5088a487-2384-4eb6-ac10-eac5d24ee1d1" },
                new BookReview { Id = new Guid("3bfc9cb2-68a5-4bb4-b100-9264e0aa2597"), Rating = 10, Comment = "A great book.", BookId = new Guid("9c8cb817-4155-48a1-8124-30a989af0d40"), UserId = "5088a487-2384-4eb6-ac10-eac5d24ee1d1" }
            );
        }
    }
}
